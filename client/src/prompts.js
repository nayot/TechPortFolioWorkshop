...
export const OUTPUT_LANGUAGE_INSTRUCTION = `ใช้ภาษาไทยเป็นภาษาหลักในทุกคำแถลงและคำอธิบาย คงศัพท์เทคนิค ชื่อเฉพาะ และชื่องานวิจัยไว้ในรูปเดิม (มักเป็นภาษาอังกฤษ)`;
