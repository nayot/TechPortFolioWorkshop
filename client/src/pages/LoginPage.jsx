  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-parchment rounded-2xl border-2 border-warm-border shadow-lg p-10 max-w-md w-full text-center">
        ...
        <button
          onClick={handleLogin}
          className="w-full flex items-center justify-center gap-3 bg-navy hover:bg-navy-hover text-white rounded-xl py-3 px-4 text-sm font-semibold transition-colors border-2 border-navy hover:border-navy-hover"
        >
        ...
        <p className="text-xs text-warm-muted/60">ข้อมูลจะถูกบันทึกใน Google Drive ของคุณ</p>
      </div>
    </div>
  );
}
